...
"site4 IN TXT \"%s\"\n" \
"site5 IN TXT \"%s,%s\"\n" \
"" % (topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'],topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][4]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan'],topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][2]['dns'][0]['ip_vlan'],topology['fog'][3]['dns'][0]['ip_vlan'],topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][4]['dns'][0]['ip_vlan'])
  with open('named', 'w') as f:
    f.write(config_)
