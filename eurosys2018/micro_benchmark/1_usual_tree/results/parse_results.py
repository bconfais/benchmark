...
nodes_mapping = [
 'QmZcYWHYFiyisVo1eYGHA2VX7fyjnBRQdfWaN3z5hXkGmo',
 'QmYqiK4nDThcoUydxH3uAxU9x4CigHCWTVNfMC8XCx2hgr',
 'QmNxCFHrNe6dTq9JXHB7ZkkNN71duD9owuPV9PW23PyB2C',
 'Qmant4xiGkq2KCbXSog7zy8CjyuRbGMQWoyypmnisF1Bqm',
 'QmQJCPoY2FWKAnKP4wG8pBStFn8FaUzYCSVUZSqpzzL4Vp'
] # in the order of the sites

topology_mapping = [
 [0, 3, 1, 1, 2], # to go from site 1 to site 1, there is 0 hops, 3 hops to go from site 1 to site 2
 [3, 0, 4, 2, 1],
 [1, 4, 0, 2, 3],
 [1, 2, 2, 0, 1],
 [2, 1, 3, 1, 0]
...
#set term postscript enhanced color eps size 3.25in,2.5in
