...
def set_ip_thread(site, node):
   ...
   if site == 0:
     ...
     commands.append("ip route add %s/32 via %s " % (topology['fog'][2]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan']))
     commands.append("ip route add %s/32 via %s " % (topology['fog'][4]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan']))
   if site == 1:
     ...
     commands.append("ip route add %s/32 via %s " % (topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan']))
   ...
   if site == 2:
     ...
     commands.append("ip route add %s/32 via %s " % (topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan']))
     commands.append("ip route add %s/32 via %s " % (topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan']))
   if site == 3:
     commands.append("ip route add %s/32 dev eth1" % (topology['fog'][0]['dns'][0]['ip_vlan']))
     commands.append("ip route add %s/32 via %s " % (topology['fog'][1]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan']))
     commands.append("ip route add %s/32 via %s " % (topology['fog'][2]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan']))
     commands.append("ip route add %s/32 via %s " % (topology['fog'][4]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan']))
   if site == 4:
     commands.append("ip route add %s/32 dev eth1" % (topology['fog'][2]['dns'][0]['ip_vlan']))
...
"site1 IN TXT \"%s,%s\"\n" \
"site2 IN TXT \"%s,%s,%s\"\n" \
"site3 IN TXT \"%s,%s,%s,%s\"\n" \
"site4 IN TXT \"%s\"\n" \
"site5 IN TXT \"%s,%s,%s,%s,%s\"\n" \
"" % (topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan'], topology['fog'][2]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][3]['dns'][0]['ip_vlan'], topology['fog'][0]['dns'][0]['ip_vlan'], topology['fog'][1]['dns'][0]['ip_vlan'], topology['fog'][2]['dns'][0]['ip_vlan'],  topology['fog'][4]['dns'][0]['ip_vlan'])
  with open('named', 'w') as f:
    f.write(config_)
