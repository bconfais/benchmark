...
nodes_mapping = [
 'QmSVsCq6ktsNEWQhzNtRzF1AqGs49dgHaE6gHoAVLpLFce',
 'QmNY7QXqvxJVEdyFMeBT8UiZp9sNL5UDS63kBnhXrK2z24',
 'QmViZNULygE377MXcXg1QcmtW3iQRgFYQizFCyy7AGJooS',
 'Qma849Z7zEB2JaKJWpMLpYwtgSQW9UAY9zv2Cv7zb5EAhe',
 'Qmb5mpGH9HCi2ttad8dXPEWs7vHaYNjvxR7DBqUPsFquBo'
] # in the order of the sites

topology_mapping = [
 [0, 2, 2, 1, 2], # to go from site 1 to site 1, there is 0 hops, 3 hops to go from site 1 to site 2
 [2, 0, 2, 1, 2],
 [2, 2, 0, 1, 2],
 [1, 1, 1, 0, 1],
 [2, 2, 2, 1, 0]
...
def main():
  ...
  results = extract({
   'dht k1': 'dht_k1_20171004.tar.gz',
   'dht k2': 'dht_k2_20171004.tar.gz',
   'dht k3': 'dht_k3_20171004.tar.gz',
